...
public class SimpleOperationBetweenTwoNumbers {
    public static void main(String[] args) {
        ...
        output = String.format("%d %s %d = %s - %s", N1, nOperator, N2, intFormatter.format(result), result.intValueExact() % 2 == 0 ? "even" : "odd");
